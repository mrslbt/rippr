...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
    tools: [
        {
            name: "rip_transcript",
            description: "Extract the full transcript from a YouTube video. Returns the video title, channel, language, and transcript text. Supports any YouTube URL format.",
            inputSchema: {
                type: "object",
                properties: {
                    url: {
                    ...
                    format: {
                        type: "string",
                        enum: ["text", "segments"],
                        description: "Output format. 'text' returns a single continuous string (best for RAG/LLM). 'segments' returns timestamped segments. Default: text.",
                    },
                },
                required: ["url"],
            },
